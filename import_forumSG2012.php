<?php
	...
	$objPHPExcel = PHPExcel_IOFactory::load("files/MAITRE_FEE_2012.xlsx");
	...
	for ($row = 2; $row <= $highestRow; ++$row) 
	{
		...
		try
		{
			$req = $conn->prepare("INSERT INTO ForumSG (anneeDeParticipation,Entreprise_nomEntreprise)VALUES (2012,:nomEntreprise)");
				$req->execute(array(
				    'nomEntreprise' => $id,
				 ));

...
<html>
	<head>
		...
		<script type="text/javascript" src="../framework/js_export/tableExport.js"> </script>
		<script type="text/javascript" src="../framework/js_export/jquery.base64.js"> </script>
		<script type="text/javascript" src="../framework/js_export/jspdf/libs/sprintf.js"> </script>
		<script type="text/javascript" src="../framework/js_export/jspdf/jspdf.js"> </script>
		<script type="text/javascript" src="../framework/js_export/jspdf/libs/base64.js"> </script>


		<script src="../js/inlinemod.js"></script>

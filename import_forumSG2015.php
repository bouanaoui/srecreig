<?php
	...
	$objPHPExcel = PHPExcel_IOFactory::load("files/Entreprise_2015.xlsx");
	...
	for ($row = 2; $row <= $highestRow; ++$row) 
	{
		...
		try
		{
			$req = $conn->prepare("INSERT INTO ForumSG(anneeDeParticipation,commentaire,Entreprise_nomEntreprise)VALUES (2015,:comm,:nomEntreprise)");
				$req->execute(array(
					'comm' => $commentaire;
				    'nomEntreprise' => $id,
				 ));
